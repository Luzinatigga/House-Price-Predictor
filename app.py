...
st.write("This app uses machine learning for predicting house price with given features of the house.For using this you can enter the inputs fromthis UI and then use predict button")
